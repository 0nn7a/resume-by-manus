...
作品圖片初步驗證（2026-08-28）：作品一 `f_001.png` 可公開載入，原始尺寸 768×1154，約 2:3；畫面為 alpJom 遊戲網站首頁。作品二 `f_004.png` 可公開載入，原始尺寸 770×1153，約 2:3；畫面為醇萃咖啡一頁式網站。兩張圖片適合直接放入目前 2:3 作品卡，不需額外裁切。


作品圖片第二批驗證（2026-08-28）：作品三 `f_003.png` 可公開載入，原始尺寸 769×1154，約 2:3；畫面為 SPOT 日式辦公室預約服務首頁。作品四 `f_002.png` 可公開載入，原始尺寸 769×1153，約 2:3；畫面為 KAKAO WEBTOON 深色網站首頁。兩張圖片可直接套用現有 2:3 作品卡。


作品圖片第三批與作品一連結驗證（2026-08-28）：作品五 `f_005.png` 可公開載入，原始尺寸 770×1154，約 2:3；畫面為城邦學習月一頁式網站。作品一 `https://0nn7a.github.io/alpjom-web/#/` 可開啟，但目前導向 alpJom 登入頁並提供「快速體驗」；外部連結本身可達。


作品外部連結第二批驗證（2026-08-28）：作品二 `https://0nn7a.github.io/230713-yohaku-layout/` 可正常載入，頁面標題為 *cu | Café，內容與作品二圖片相符。作品三 `https://0nn7a.github.io/230629-thespot-layout/` 可正常載入，頁面標題為 SPOT｜1日オフィス・貸し会議室予約サービス，內容與作品三圖片相符。


作品外部連結第三批驗證（2026-08-28）：作品四 `https://0nn7a.github.io/kakaowebtoon/` 可正常載入，頁面標題為 KAKAO WEBTOON，內容與作品四圖片相符。作品五 `https://www.cake.me/portfolios/rwd-376bc5` 可正常載入，頁面標題為 `[前端][網頁切版]RWD一頁式行銷網站 | 林家淇’s Portfolio`，頁面可讀且含城邦學習月作品內容。
